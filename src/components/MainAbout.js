        ...
        <div className="mainSection">
          <section>
            ...
            <div id="wrapper">
              <p>
                <strong>
                  Zakład Budżetowy Związku Gmin „EKOWOD” w Lidzbarku Warmińskim został utworzony
                  przez Związek Gmin „EKOWOD” w 1997 roku, na podstawie uchwał następujących Rad
                  Gmin: Lidzbark Warmiński, Górowo Iławeckie, Kolno oraz Lubomino. Na terenie tych
                  gmin zakład dostarcza wodę mieszkańców oraz odbiera i oczyszcza ścieki komunalne.
                </strong>
              </p>
              <p>
                Firma dysponuje 28 stacjami uzdatniania wody, 14 oczyszczalniami ścieków, 53
                studniami głębinowymi, przepompowniami wody i ścieków oraz sieciami
                wodociągowo-kanalizacyjnymi. Roczna produkcja wody w zakładzie kształtuje się na
                poziomie ok. 600-630tys. m3, a ilość odprowadzanych ścieków to ok. 150 tys. m3.
              </p>
              <div id="wrapperAbout">
                <div>
                  Produkowana przez „EKOWOD” woda spełnia wszelkie wymagania dla wody pitnej, a jej
                  jakość jest stale monitorowana przez akredytowane laboratoria oraz powiatowe
                  stacje sanitarno – epidemiologiczne. Większość stacji uzdatniania wody to obiekty
                ...
                <div>
                  ...
                  oczyszczania ścieków opiera się na metodzie osadu czynnego. W dyspozycji zakładu
                  są również oczyszczalnie typu SBR oraz Biocler. Jakość odprowadzanych przez
                  „EKOWOD” ścieków odpowiada wszelkim normom wymaganym przez polskie prawo.
                </div>
              </div>
              <p>
                ...
                nowy pojazd pogotowia technicznego oraz urządzenie wysokociśnieniowe, co pozwoliło
                na stworzenie w następnym roku większej liczby ekip remontowo-naprawczych oraz
                zwiększenie zatrudnienia. W 2017 roku zakład przeniósł też swoją wieloletnią
                siedzibę z Bartoszyc do Lidzbarka Warmińskiego. Lokalizacja ta jest bardziej dogodna
                dla mieszkańców obsługiwanych gmin, ponieważ ułatwia odbiorcom bezpośredni kontakt z
              ...
              <p>
                ...
                stale podwyższanie jakości usług zarówno związanych ze zbiorowym zaopatrzeniem w
                wodę, jak i odprowadzaniem ścieków. Pracownicy dokładają wszelkich starań, aby
                racjonalna działalność zakładu miała odzwierciedlenie w konkurencyjnych cenach
                oferowanych odbiorców.
              </p>
            </div>
