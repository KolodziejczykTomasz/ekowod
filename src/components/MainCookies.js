        ...
        <section>
          ...
          <div>
            <p id="cookiesTitle">
              ...
              internauta może wyrazić zgodę poprzez odpowiednie ustawienia przeglądarki
              internetowej. Od chwili uzyskania tych informacji decyzja korzystania z serwisu bez
              zmiany ustawień przeglądarki jest traktowana jako świadomy wybór użytkownika.
            </p>
            <ol id="cookiesListNumber">
              ...
              <li>
                ...
                <ul>
                  ...
                  <li>
                    o tworzenia statystyk, które pomagają zrozumieć, w jaki sposób Użytkownicy
                    Serwisu korzystają ze stron internetowych, co umożliwia ulepszanie ich struktury
                    i zawartości;
                  </li>
                  <li>
                    o utrzymania sesji Użytkownika Serwisu (po zalogowaniu), dzięki której
              ...
              <li>
                ...
                <ul>
                  <li>
                    o „niezbędne” pliki cookies, umożliwiające korzystanie z usług dostępnych w
              ...
              <li>
                ...
                dalszej części niniejszego dokumentu. Szczegółowe informacje o możliwości i
                sposobach obsługi plików cookies dostępne są w ustawieniach oprogramowania
                (przeglądarki internetowej) oraz w plikach pomocy dostępnych w menu przeglądarki.
              </li>
              <li>
              ...
              <li>
                ...
                partnerów oraz podmiotów trzecich (np. Facebook, Twitter, Google itp.).
              </li>
              <li>
            ...
            <p>
              ...
              internetowej, z której korzysta użytkownik. Informacje na temat plików cookies
              znajdują się w zakładce „Pomoc” w każdej przeglądarce internetowej.
            </p>
            ...
            <p>
              Domyślne ustawienia przeglądarki Microsoft Internet Explorerze zwalają na
              przechowywanie plików cookies, ale blokują pliki, które mogą pochodzić z serwisów
              niestosujących polityki prywatności. Aby zmienić ustawienia należy:
            </p>
            <ul>
            ...
            <p>
              ...
              reklamy. Oprogramowanie Adobe Flash Player również używa plików cookies. Dostęp do
              nich możliwy jest dzięki mechanizmowi na stronie internetowej Adobe:
